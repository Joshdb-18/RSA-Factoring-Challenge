...
|[RSA-150](https://en.wikipedia.org/wiki/RSA-150)| 150 | 496 |	---     | April 16, 2004 | [Kazumaro Aoki](ht Popovyan, [Mosco State University](https://en.wikipedia.org/wiki/Moscow_State_University)|
...
|[RSA-250](https://en.wikipedia.org/wiki/RSA-250)| 250  1028 |	---     | --- | --- |
...
- we will only run your eien@ubuntu:~/RSA Factoring Challenge$ cat tests/rsa-1
6
...
`` n =tps://en.wikipedia.org/wiki/Kazumaro_Aoki)|
...
|[R270](https://en.wikipedia.org/wiki/RSA-270)| --- | --- | ---      | --- | --- |
...
|[RSA-310](https://en.wikipedia.org/wiki/RSA-310)| 310 |SA Secret-Key Challenge](https://en.wikipedia.org/wiki/RSA_Secret-Key_Challenge)
- [Integer factorization records](https://en.wikipedia.org/wiki/Integer_factorization_records)

## Background Context

We have sniffed a8=64*2
1024=512*2
4958=2479*2
...
The first RSA numbers generated, RSA-100 to RSA-500 and RSA-617, were labeled according to their number of [decimal](https://en.wikipedia.orSA-160](https://en.wikipedia.org/wiki/RSA-160)| 160 | 530 |	---     | April 1, 2003 | [Jens Franke](https://en.wikipedia.org/wiki/Jens_Franke)., [University of Bonn](https://en.wikipedia.org/wiki/University_of_Bonn)|
...
|[RSA-180](https://en.wikipedia.org/wiki/RSA-180)| 180 | 596 |  ---     | May 8, 2010 | S.A Danilov and I.A| 829 |  ---     | Feb 28, 2020 | F. Boudot, P. Gaudry, A. Guillevic, N. Heninger, E. Thomé and P. Zimmermann|
|[RSA-260](https://en.wikipedia.org/wiki/RSA-260)| 260 | 862 |  ---     | --- | --- |	
|[RSA-n unsecured network and found numbers that are used to encrypt very important documents. It seems that those numbers are not always generated using large enough prime numbers. Your mission should you choose to accept it, is to factorize these numbers as fast as possible before the target fixes this bug on their server - so that we can decode the encrypted documents.
...
- You can choose the language of your choxecutable ``factors``
